...
async function run() {
  ...
  const runNumber = context2.runNumber;
  ...
  if (!version) {
    const repoPkgJson = JSON.parse(await (0, import_promises.readFile)("./package.json", "utf8"));
  ...
  info(
    `isForcePreid: ${isForcePreid}, Branch: ${branch}, ContextRef: ${context2.ref}, Version: ${version}, RunNumber: ${runNumber}, PreidBranches: ${preidBranches}`
  );
  let versionSuffix;
