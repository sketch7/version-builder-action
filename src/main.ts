...
export async function run(): Promise<void> {
	...
	core.info(
		`forcePreid: ${forcePreid}, Branch: ${branch}, contextRef: ${github.context.ref}, version: ${version}, runNumber: ${runNumber}, preidBranches: ${JSON.stringify(preidBranches)}`,
	)
	...
	const resolvedPreid = resolvePreid({ branch, preidBranches, defaultPreid, forcePreid, forceStable })
